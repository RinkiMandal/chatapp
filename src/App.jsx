...
//   const handleBack = () => setSelectedUserId(null); // for mobile back button
...
//         {/* SIDEBAR */}
//         <div className={`w-full md:w-[300px] ${selectedUserId ? "hidden md:block" : "block"}`}>
//           <Sidebar
//             activeChatId={selectedUserId}
//             onSelectChat={setSelectedUserId}
//             darkMode={darkMode}
...
//         {/* CHAT WINDOW */}
//         <div className={`flex-1 ${selectedUserId ? "block" : "hidden"} md:block`}>
//           {selectedUser ? (
//             <ChatWindow
//               user={selectedUser}
//               messages={messages}
//               onBack={handleBack} // mobile back handler
//             />
//           ) : (
